...
export function getDefaultModelSource() {
    if (process.env.BEREAN_MODEL)
        return 'BEREAN_MODEL env';
    if (process.env.BEREANMODEL)
        return 'BEREANMODEL env';
 ...
 */
export function getDefaultLanguageSource() {
    if (process.env.BEREAN_LANGUAGE)
        return 'BEREAN_LANGUAGE env';
    if (process.env.BEREANLANGUAGE)
        return 'BEREANLANGUAGE env';
 ...
 */
export function getGitHubTokenFromAzure() {
 ...
 */
export function getAzureDevOpsPATFromPipeline() {
